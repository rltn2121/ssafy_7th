...
<body>
    ...
    <div id="Info">
        <div id="information">
            <h1>거래정보</h1>
			<%
				List<HouseDeal> list = (List)request.getAttribute("list");
        		if(list.size()==0){
			%>            
            ...
            <div class="apart">
                <div><a href = "/HappyHouse4/house?act=detail&no=<%= hd.getNo() %>"><h3><%=hd.getAptName() %></h3></a></div>
                <div>거래금액: <%= hd.getDealAmount() %></div>
                <div>면적: <%=hd.getArea() %></div>
            </div>
            <br>
